...
//
////        String jwt = WeChatUtils.getAccessToken("wxc2aea09ab96e5ddb", "e757d5bdfa4b63b40904ff9cdb9f69d7");
////        org.json.JSONObject qrParam = new org.json.JSONObject();
////        qrParam.put("QrCodeId", "ffc2f11705ad47e9bd28c1f588f3a3bd");
////        String result = WeChatUtils.getParamQrCode(jwt, qrParam.toString());//二维码的附带参数字符串类型，长度不能超过64
