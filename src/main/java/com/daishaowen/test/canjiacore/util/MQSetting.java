...
public class MQSetting {
    public static final String TOPIC_RESTO_SHOP;
    public static final String PID_SHOP;
    public static final String CID_SHOP;
    public static final String CID_ORDER;
    public static final String TOPIC_NAME;//队列名称（用于提示作用）
...
//    public static final Boolean OPEN_TASK;  //当前MQ是否开启定时任务
    ...
    static {
        Map<String, Object> topicMap = getQueueInfo();
        TOPIC_RESTO_SHOP = topicMap.get("topic_resto_shop").toString();
        PID_SHOP = topicMap.get("pid_shop").toString();
        CID_SHOP = topicMap.get("cid_shop").toString();
        CID_ORDER = topicMap.get("cid_order").toString();
        TOPIC_NAME = topicMap.get("topic_name").toString();
