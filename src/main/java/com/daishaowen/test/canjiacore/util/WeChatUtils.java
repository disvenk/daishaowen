...
//    }
//
//    public static String getUserInfo(String jwt, String openid) {
//        StringBuffer url = new StringBuffer(GET_USER_INFO_URL + "?");
//        url.append("access_token=" + jwt);
//        url.append("&openid=" + openid);
//        url.append("&lang=zh_CN");
//        return HttpRequest.get(url.toString()).body();
//    }
//
//    public static String getUserInfoSubscribe(String jwt, String openid) {
...
//        String url = ACCESS_CACHE_SERVER + "/jwt/getstr/" + appid + "/" + secret;
//        return HttpRequest.get(url).body();
//    }
//
//    public static void flushAccessToken(String appid, String secret) {
//        String url = ACCESS_CACHE_SERVER + "/jwt/flush/" + appid + "/" + secret;
...
//            doPostAnsc("http://139.196.222.182:8580/pos/posAction",map);
//        }
//        return result;
//    }
//
...
//        // 将 jwt, timestamp, nonce 三个参数进行字典排序
//        Arrays.sort(arr);
...
//                doPostAnsc("http://139.196.222.42:8580/pos/posAction",map);
//            }
//        });
//        t.start();
//    }
...
//     * @return
//     */
//    public static String getParamQrCode(String jwt,String qrParam) {
//        String url = GET_PARAM_QRCODE + jwt;
