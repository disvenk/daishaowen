...
public class ExportExcelUtil {
     ...
     * 导出Excel
     */
    public static void exportExcel(HttpServletRequest request, HttpServletResponse response, String title, String[] headers, List<Object[]> dataList) {
        //使用流将数据导出
        try {
            //防止中文乱码
            ...
            ExportExcelUtil ex = new ExportExcelUtil(title, headers, dataList);//没有标题
            ex.export(out);
        } catch (Exception e) {
            e.printStackTrace();
        }
