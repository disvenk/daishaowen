...
public class CompressedFileUtil {
    ...
    public static void createCompressedFile(ZipOutputStream out,File file,String dir) throws Exception{
        ...
        if(file.isDirectory()){
            ...
            //指定默认文件名
            dir = dir.length() == 0 ? file.getName() : dir;
            out.putNextEntry(new ZipEntry(dir));
            //进行写操作
            int j =  0;
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            CompressedFileUtil.compressedFile("F:\\kaa\\kaa\\kaa_suplier\\target\\kaa_suplier\\assets\\templete\\aa\\asd.txt",
                    "F:\\kaa\\kaa\\kaa_suplier\\target\\kaa_suplier\\assets\\templete");
