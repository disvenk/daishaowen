...
public class ReflectUtils {
    ...
    public static Object parseActualTypeValue(Field field, Object value, boolean isEnumConvertToString) throws Exception {
        ...
        if (tp.getClass() == TypeVariableImpl.class) {
            //TODO 通过反射方式获取泛型值类型，还存在一定问题，先暂用 com.xxx.canjiacore.entity.GenericEntity 固定死！
            ParameterizedTypeImpl pti = (ParameterizedTypeImpl) Class.forName("com.xxx.canjiacore.entity.GenericEntity").getGenericSuperclass();
            if (pti == null) throw new Exception("无法获取泛型父类，com.xxx.canjiacore.entity.GenericEntity 可能已变更");
