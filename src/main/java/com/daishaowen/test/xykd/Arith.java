...
/**
 * Created by disvenk on 17/3/11.
 * 于Java的简单类型不能够精确的对浮点数进行运算，这个工具类提供精 确的浮点数运算，包括加减乘除和四舍五入。
 */
public class Arith {
    // 默认除法运算精度
    ...
    public static double sub3(double v1, double v2,double v3) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arith.div(120, 2, 3));
    }
}
