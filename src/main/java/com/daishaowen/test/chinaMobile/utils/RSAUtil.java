...
public class RSAUtil {
	 ...
	 *
	 */
	public static boolean verify(final byte[] data, final String publicKey,
			final String sign) throws Exception {// NOPMD
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> initKey() throws Exception {// NOPMD
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptBASE64(final String key) throws Exception {// NOPMD
	 ...
	 * @throws Exception
	 */
	public static String encryptBASE64(final byte[] key) throws Exception {// NOPMD
