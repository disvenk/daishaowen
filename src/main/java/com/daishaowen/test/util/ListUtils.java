...
public class ListUtils {
   ...
   private static final String PREX="(?<=\\{)(.+?)(?=\\})"; 
    ...
    /**
    * 将数据源【SSSS】{name}先生你好，你与{time}今天，购买的商品{goodsName}已经发货！ 
    * 中大括号中的内容，以集合的形式输出 name，time，goodsName
    * @author Edwin Yu  
    * @date 2018-6-12
     */
     public static List<String> getSubUtil(String soap){   //数据源   
        List<String> list = new ArrayList<String>();    
        Pattern pattern = Pattern.compile(PREX);// 匹配的模式    
