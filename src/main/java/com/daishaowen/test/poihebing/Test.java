...
public class Test {
    ...
    public static String createExcel(String[] title, Map<String/*sheet名*/, List<Map<String/*对应title的值*/, String>>> maps, int[] mergeIndex){
        ...
        try {
            ...
            out = new FileOutputStream(localPath.replace("C:\\Users\\wxm\\AppData\\Local\\Temp\\","C:\\Users\\wxm\\Desktop\\"));
            workbook.write(out);
        }catch (IOException e){
            e.printStackTrace();
        }finally {
    ...
    public static void main(String[] args) throws IOException{
        ...
        map.put("测试合并数据", list);
        System.out.println(createExcel(title, map, new int[]{0,1,2,3,4}/*此处数组为需要合并的列，可能有的需求是只需要某些列里面相同内容合并*/));
    }
