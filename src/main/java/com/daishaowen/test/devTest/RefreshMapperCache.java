                ...
                for (Resource configLocation : mapperLocations) {
                    try {
                        ...
                        if(changeResourceNameList.contains(configLocation.getFilename())){
                            XMLMapperBuilder xmlMapperBuilder = new XMLMapperBuilder(new InputStreamReader(configLocation.getInputStream()), configuration, configLocation.toString(),sqlFragments);
